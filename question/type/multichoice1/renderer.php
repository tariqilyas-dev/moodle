 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qtype_multichoice1_renderer_base extends qtype_with_combined_feedback_renderer {
     ...
     * options returned by {@link qtype_multichoice1:;get_numbering_styles()}.
    ...
    protected function correct_choices(array $right) {
        ...
        if (count($right) == 1) {
                return get_string('correctansweris', 'qtype_multichoice1',
                        implode(', ', $right));
        } else if (count($right) > 1) {
                return get_string('correctanswersare', 'qtype_multichoice1',
                        implode(', ', $right));
        } else {
                return "";
        }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multichoice1_single_renderer extends qtype_multichoice1_renderer_base {
    ...
    protected function prompt() {
        return get_string('selectone', 'qtype_multichoice1');
    }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multichoice1_multi_renderer extends qtype_multichoice1_renderer_base {
    protected function get_input_type() {
        return 'checkbox';
    }
    ...
    protected function prompt() {
        return get_string('selectmulti', 'qtype_multichoice1');
    }
    ...
    protected function num_parts_correct(question_attempt $qa) {
        if ($qa->get_question()->get_num_selected_choices($qa->get_last_qt_data()) >
            ...
            return get_string('toomanyselected', 'qtype_multichoice1');
        }
