 ...
 * needed to restore one multichoice1 qtype plugin
 *
 * @copyright  2010 onwards Eloy Lafuente (stronk7) {@link http://stronk7.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qtype_multichoice1_plugin extends restore_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        // Add own qtype stuff.
        $elename = 'multichoice1';
        // We used get_recommended_name() so this works.
        $elepath = $this->get_pathfor('/multichoice1');
    ...
    /**
     * Process the qtype/multichoice1 element
     */
    public function process_multichoice1($data) {
        global $DB;
        ...
        // qtype_multichoice1_options too.
        if ($questioncreated) {
            $data->questionid = $newquestionid;

            // It is possible for old backup files to contain unique key violations.
            // We need to check to avoid that.
            if (!$DB->record_exists('qtype_multichoice1_options', array('questionid' => $data->questionid))) {
                $newitemid = $DB->insert_record('qtype_multichoice1_options', $data);
                $this->set_mapping('qtype_multichoice1_options', $oldid, $newitemid);
            }
        }
    }
     ...
     * recoded pointing to all the restored stuff for multichoice1 questions
     *
    ...
    public static function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('qtype_multichoice1_options',
                $fields, 'qtype_multichoice1_options');
