 ...
 *
 * Note, there are already lots of tests of the multichoice1 type in the behaviour
 * tests. (Search for test_question_maker::make_a_multichoice1.) This file only
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multichoice1_walkthrough_test extends qbehaviour_walkthrough_test_base {
    public function test_deferredfeedback_feedback_multichoice1_single() {

        // Create a multichoice1, single question.
        $mc = test_question_maker::make_a_multichoice1_single_question();
    ...
    public function test_deferredfeedback_feedback_multichoice1_multi() {
        // Create a multichoice1, multi question.
        $mc = test_question_maker::make_a_multichoice1_multi_question();
        $mc->shuffleanswers = false;
